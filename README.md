...
Пользователи получают points за один tip согласно правилам, заданным в настройках проекта. За tips со статусом Lost, Push или Void пользователь получает 0 points.
...
ВАЖНО! Если в рамках Contest активирована опция "Simple Contest",то для этого турнира автоматически активируються только 2 маркета: 1X2, Correct Score. За правильно угаданый результат по кажному из этих маркетов можна задать точное кол-во очков. Опция "Simple Contest" отменяет градацию очков с привязкой к вероятностям, которая задается на уровне проекта. Также для "Simple Contest" не нужно задавать минимальный и максимальний коэффициент. 
