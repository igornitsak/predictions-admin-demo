...
ВАЖНО! Если в рамках Contest активирована опция "Simple Contest", то для этого турнира автоматически активируются только 2 маркета: 1X2, Correct Score. За правильно угаданый результат по кажному из этих маркетов можна указать точное кол-во очков. Опция "Simple Contest" отменяет градацию очков с привязкой к вероятностям, которая задается на уровне проекта. Также для "Simple Contest" не нужно задавать минимальный и максимальний коэффициент. 
